        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <AnimatedSection animation="fade-up" delay={100}>
              <div id="windows" className="bg-sand-100 rounded-xl p-8 h-full">
                ...
                <h3 className="text-2xl font-bold text-dark-800 mb-4">Window Installation</h3>
            ...
            <AnimatedSection animation="fade-up" delay={200}>
              <div id="roofing" className="bg-sand-100 rounded-xl p-8 h-full">
                <div className="w-14 h-14 bg-primary-500/10 rounded-xl flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-dark-800 mb-4">Roofing Services</h3>
                <p className="text-gray-600 mb-6">
            ...
            <AnimatedSection animation="fade-up" delay={300}>
              <div id="handyman" className="bg-sand-100 rounded-xl p-8 h-full">
                <div className="w-14 h-14 bg-primary-500/10 rounded-xl flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-2xl font-bold text-dark-800 mb-4">Handyman Services</h3>
                <p className="text-gray-600 mb-6">
            ...
            <AnimatedSection animation="fade-up" delay={400}>
              <div id="pressure-washing" className="bg-sand-100 rounded-xl p-8 h-full">
                <div className="w-14 h-14 bg-primary-500/10 rounded-xl flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-dark-800 mb-4">Pressure Washing</h3>
                <p className="text-gray-600 mb-6">
